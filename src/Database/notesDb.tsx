...
export async function saveNewNote(date:string,title:string,body:string,noteType:string,filePath:string,userId:number,db:any, ) {
    ...
    try{
        ...
        await db.runAsync(`INSERT INTO notes (date,title,body,noteType,filePath,userId) VALUES (?,?,?,?,?,?)`,[date,title,body,noteType,filePath,userId]);
